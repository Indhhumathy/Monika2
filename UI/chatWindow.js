function koreBotChat() {
    ...
    //     // var myDiv = $(this).closest("reword");
    //     // console.log($(this)[0].getAttribute('title'));
    //     // console.log($(myDiv).title);
    //     var msgText = $(this)[0].getAttribute('title');
    //     console.log(msgText);
    //     alert(msgText);
    //     bot.sendMessage(msgText, function messageSent() {
...
" Will automation help in programming field ? " 
    ...
    chatWindow.prototype.renderMessage = function (msgData) {
		...
		if(messageHtml === '') {
            ...
            /* code added by me for popup ----------- */
            var comp = msgData.message[0].component;
            if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && comp) {
